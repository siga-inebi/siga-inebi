...
| Seguridad | Persona 1 | Alcances, autenticación, cuentas y sus pantallas | **Lun 17** |
| Académico | Persona 2 | Ciclo, secciones, cupos, asignaciones y sus pantallas | **Lun 17** |
| Expediente | Persona 3 | Estudiantes, encargados, contactos y sus pantallas | **Mar 18** |
| Bitácora | Persona 7 | Auditoría, consultas restringidas y su pantalla | **Mar 18** |
| Documental | Persona 4 | Plantillas, documentos, archivos, emisión y sus pantallas (carril ampliado) | **Mié 19** |
| Asistencia | Persona 5 | Jornada, captura, presencia y sus pantallas | **Mié 19** |
| Evaluación | Persona 6 | Calificaciones, resultados y sus pantallas | **Mié 19** |
...
| Lun 17 | Personas 1 y 2 | Persona 8 (+ quien ya tenga context de identity/academics) |
| Mar 18 | Personas 3 y 7 | Personas 1 y 2 |
| Mié 19 | Personas 4, 5 y 6 | Personas 1, 2 y 8 |
...
**Persona 4 (adelanto, sin día de merge obligatorio aún):** puede empezar ya el paquete autónomo de
...
### Lunes 17 — Personas 1 y 2 (desbloquean al resto)

**Persona 1 — merge del carril completo:**
...
**Persona 2 — merge del carril completo:**
...
### Martes 18 — Personas 3 y 7

**Persona 3 — merge del carril completo:**

- [#185](https://github.com/siga-inebi/siga-inebi/issues/185)–[#189](https://github.com/siga-inebi/siga-inebi/issues/189)
- [#191 RF-EXP-007](https://github.com/siga-inebi/siga-inebi/issues/191)
- [#192 RF-EXP-008](https://github.com/siga-inebi/siga-inebi/issues/192)
- Pantallas de alta, consulta, encargados, contactos y foto.

**Persona 7 — merge del carril completo:**
...
### Miércoles 19 — Personas 4, 5 y 6 (freeze 17:00)

**Persona 4 — carril ampliado (merge del corte oficial + lo autónomo que alcance):**
...
**Persona 5 — merge del carril completo:**
...
**Persona 6 — merge del carril completo:**
...
flowchart LR
    ...
    P1["Persona 1<br/>Lun 17 · alcance y cuentas"]
    P2["Persona 2<br/>Lun 17 · ciclo y estructura"]
    P3["Persona 3<br/>Mar 18 · expediente"]
    P7["Persona 7<br/>Mar 18 · bitácora"]
    P4["Persona 4<br/>Mié 19 · docs, archivos, emisión"]
    P5["Persona 5<br/>Mié 19 · jornada y asistencia"]
    P6["Persona 6<br/>Mié 19 · evaluación"]
...
flowchart TD
    ...
    L17["Lun 17<br/>Personas 1 y 2"] -->
    M18["Mar 18<br/>Personas 3 y 7"] -->
    X19["Mié 19<br/>Personas 4, 5 y 6 · freeze 17:00"] -->
...
|---|---|---|
| PR #346 (vie 14) | Personas 1–7 | Seguir en backend/pruebas en su rama; no inventar componentes visuales alternativos. |
| Personas 1 o 2 (lun 17) | Personas 3–6 | Seguir con fixtures y contrato publicado; no mergear escrituras que asuman alcance/ciclo reales. |
| Persona 3 (mar 18) | Persona 4 y 5 | Completar catálogo/captura sin vínculo fuerte al estudiante; integrar vínculo el jueves si aplica. |
| Persona 7 (mar 18) | Personas 1–6 | Conservar pruebas del dominio; integrar auditoría en follow-up el jueves sin bloquear el merge del miércoles. |
| Persona 4 sin plantilla/docs | Emisión | No inventar plantilla ficticia; dejar #156 para el jueves o el siguiente sprint. |
