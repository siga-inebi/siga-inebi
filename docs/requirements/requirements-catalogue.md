...
| RF-EXP-009 | Notas de salud del estudiante | Deberia | student-records | Implemented | #193 | backend/tests/api/test_student_health_notes_api.py; backend/tests/unit/test_student_health_note_services.py; frontend/src/test/AlumnosPage.test.jsx | Sensitive Special; lectura y escritura auditadas; permiso sensible y alcance obligatorio |
