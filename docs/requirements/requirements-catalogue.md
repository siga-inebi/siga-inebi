...
| RF-CIC-002 | Estados del ciclo | Debe | school-cycle | In progress | #127 | backend/tests/unit/test_academics_services.py; backend/tests/integration/test_academics.py; backend/tests/unit/test_teaching_assignment_services.py; backend/tests/api/test_teaching_assignments_api.py | Estados y activo unico implementados; carga docente cerrada bloqueada; visibilidad por portal y otros dominios pendientes |
