...
| RF-MAT-001 | La inscripcion como registro con vigencia | Debe | enrollment-lifecycle | Not implemented | TBD | TBD | Nucleo fundacional |
| RF-MAT-002 | Matricula de un estudiante | Debe | enrollment-lifecycle | Not implemented | TBD | TBD | Nucleo fundacional |
| RF-MAT-003 | Reinscripcion con datos heredados | Debe | enrollment-lifecycle | Not implemented | TBD | TBD | Nucleo fundacional |
| RF-MAT-004 | Efecto del cupo de la seccion | Debe | enrollment-lifecycle | Not implemented | TBD | TBD | Regla central |
...
| RF-MOV-001 | Distincion entre cambio de seccion y traslado | Debe | enrollment-lifecycle | Not implemented | TBD | TBD | Regla de movilidad |
| RF-MOV-002 | Cambio de seccion sin perdida de informacion | Debe | enrollment-lifecycle | Not implemented | TBD | TBD | Historia obligatoria |
...
| RF-MOV-004 | Retiro del estudiante | Debe | enrollment-lifecycle | Not implemented | TBD | TBD | Regla de permanencia |
