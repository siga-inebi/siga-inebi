...
| Credencial | Identificador fisico o digital del estudiante con QR opaco. |
| Dominio | Area coherente de negocio y reglas dentro de monolito modular. |
| Encargado | Padre, madre o responsable vinculado a estudiante. |
| Estado derivado | Resultado calculado desde eventos, reglas y justificaciones. |
| Evento de asistencia | Movimiento inmutable de ingreso, salida u otro tipo autorizado. |
