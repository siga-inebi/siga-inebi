...
- Las escrituras academicas consultan una politica compartida de estado del ciclo. Un ciclo cerrado
  ...
  HTTP 400. Las consultas historicas permanecen disponibles y no se eliminan. La auditoria
  transversal de denegaciones corresponde a RF-BIT-004 y RNF-SEG-003 y no se declara implementada
  en este cambio.
